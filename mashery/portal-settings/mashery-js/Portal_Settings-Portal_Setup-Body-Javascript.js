...
function () {
    ...
    var e = $('<div class="top-bar-section"></div>').append($(".local").remove().children()).append('<ul><li class="search">' + t.children(".search").addClass("left").remove().html() + "</li></ul>").append('<ul class="mmade"><li class="mashery-made"><a href="http://mashery.com">Mashery Made</a></li></ul>');
...
var headerbar ='<div class="navbar-holder navbar-fixed-top"><div class="navbar dark-blue-bk top"><div class="container"><ul class="nav navbar-nav"><li style="display:none;"><a href="blog.html" id="blog-link">Blog</a></li><li style="display:none;"><a href="#signin" id="signin-link">Sign In</a></li><li class="dropdown text-right"><a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdown">My Account <span class="glyphicon glyphicon-user"></span></b></a><ul class="dropdown-menu"><li class="dropdown-header">My Account</li><li><a href="/apps/myapps">My Applications</a></li><li><a href="/apps/mykeys">My API Keys</a></li><li><a href="/member/edit">My Settings</a></li><li><a href="/apps/register">Register Application</a></li><li style="display:none;"><a href="#signout">Sign Out</a></li></ul></li></ul></div></div><div class="navbar navbar-inverse main dark-box-shadow"><div class="container"><div class="navbar-header"><a class="navbar-brand logo" href="/Home">Hearst Developer API</a><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".navbar-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button></div><ul class="nav navbar-nav navbar-collapse collapse navbar-right"><li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="icon-api"></span>Explore <b class="caret"></b></a><ul class="dropdown-menu" role="menu"><li class="dropdown-header">By Industry</li><li><a role="menuitem" tabindex="-1" href="/industries/electronics">Magazines</a></li><li><a role="menuitem" tabindex="-1" href="/industries/automotive">Automotive</a></li><li><a role="menuitem" tabindex="-1" href="/industries/healthcare">Healthcare</a></li><li><a role="menuitem" tabindex="-1" href="/industries/finance">Data Services</a></li></ul></li><li><a href="/io-docs"><span class="icon-iodocs"></span>I/O Docs</a></li><li class="nav-register"><a href="/member/register"><span class="icon-key"></span>Register</a></li></ul></div></div></div>'

$('.header').prepend(headerbar);

/****** blog header ****/

var blogHeader ='<div class="jumbotron internal"><h1 class="jumbotron-heading white-text-shadow white-text helvetica-neue-bold-condensed">Hearst Developer Blog</h1><h2 class="navy-blue garamond-italic text-center">Follow our nerdy whereabouts.</h2></div>';

$('body#page-blog .content').prepend(blogHeader);
...
/************ move elements *******************************************************/
$("div#user-nav ul .dashboard").prepend('<li class="forum"><a href="/forum">Forum</a></li>');
$("div#user-nav ul .last" ).prepend( $( "body.signed-in .navbar-nav li.dropdown" ) );
$(".top-bar-section ul").first().css("float:left");
$(".top-bar-section ul").first().addClass("nav");
$("#page-apps.register .section-body table").first().addClass("apps-reg");
$( "#page-docs .section-body" ).prepend( $( ".sub" ) );
/************ carousel *******************************************************/
$(document).ready(function() { 
  $('.carousel').carousel({ interval: 3500, cycle: true });
});
